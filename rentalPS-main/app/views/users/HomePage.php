            ...
            <section class="relative py-20 md:py-32 bg-white/50">
                ...
                <div class="container mx-auto px-4 relative text-center">
                    ...
                    <div class="mt-8 flex justify-center gap-4">
                        <a href="/users/pesansesi" class="inline-flex items-center px-6 py-3 bg-[#29ABE2] text-white font-medium rounded-md hover:bg-[#1a8cc0] text-lg">
                            Pesan Sesi
                        </a>
                        <a href="/menu" class="inline-flex items-center px-6 py-3 border border-[#29ABE2] text-[#29ABE2] font-medium rounded-md hover:bg-[#29ABE2]/10 text-lg">
                            Lihat Menu <i data-lucide="arrow-right" class="ml-2 h-4 w-4"></i>
                        </a>
                    </div>
                </div>
            </section>
            ...
            <section class="py-16 md:py-24 bg-white/50">
                <div class="container mx-auto px-4">
                    <div class="flex items-center justify-between">
                        ...
                        <a href="/users/pesansesi" class="inline-flex items-center text-[#29ABE2] hover:underline">
            ...
            <section class="py-16 md:py-24">
                <div class="container mx-auto px-4">
                    <div class="flex items-center justify-between">
                        ...
                        <a href="/menu" class="inline-flex items-center text-[#29ABE2] hover:underline">
