    ...
    <nav class="bg-[#F0F2F5] border-b border-gray-200">
        <div class="container mx-auto px-4 py-4">
            <div class="flex justify-between items-center">
                <a href="/" class="flex items-center space-x-2 text-2xl font-bold text-[#29ABE2] font-['Space_Grotesk']">
                ...
                <div class="hidden md:flex space-x-6" id="navbar-menu">
                    <a href="/" class="text-[#29ABE2] hover:text-[#F47920] font-medium">Beranda</a>
                    <a href="/pesan-sesi" class="text-[#29ABE2] hover:text-[#F47920] font-medium">Pesan Sesi</a>
                    <a href="/menu" class="text-[#29ABE2] hover:text-[#F47920] font-medium">Menu</a>
                    <a href="/rekomendasi" class="text-[#29ABE2] hover:text-[#F47920] font-medium">rekomendasi</a>
                </div>
            </div>
